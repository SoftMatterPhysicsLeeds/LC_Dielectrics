...
class AgilentSpectrometer():
    ...
    def initialise(self) -> None:
        ...
        address = rm.list_resources()[0] # USB interfaces are usually first - might need to change this to make it more generic or add dropdown to select address.
        ...
        try: 
            ...
            if self.spectrometer == "Agilent Technologies,E4980A,MY46309287,A.06.11":
                print("Connected to E4980A")
            else: 
                raise Exception("Could not connect to E4980A. Check address is correct.")
